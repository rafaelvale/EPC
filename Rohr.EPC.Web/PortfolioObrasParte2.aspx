<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterDefault.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="PortfolioObrasParte2.aspx.cs" Inherits="Rohr.EPC.Web.PortfolioObrasParte2" %>
        ...
        <div class="row">
            ...
            <div class="span9">
                ...
                <div class="row">
                    <div class="span9">
                        <fieldset>
                            <legend>Portfólio de Obras - Parte 2</legend>
